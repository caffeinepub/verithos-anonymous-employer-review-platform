...
import { CompanyEdit } from '../backend';
import { Calendar, User, FileText, X } from 'lucide-react';

interface CompanyEditHistoryTimelineProps {
  companyId: string;
  editHistory: CompanyEdit[];
}

export default function CompanyEditHistoryTimeline({ companyId, editHistory }: CompanyEditHistoryTimelineProps) {
